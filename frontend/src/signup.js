    ...
    <section className="bg-yellow-50 dark:bg-yellow-900">
        ...
        <div className="w-full bg-white rounded-lg shadow-md dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            ...
            <form className="space-y-4 md:space-y-6" onSubmit={handlesubmit}>
                ...
                <input type="email" onChange={changeval} value={newuser.email} name="email" id="email" className="bg-yellow-100 border border-yellow-300 text-gray-900 sm:text-sm rounded-lg focus:ring-red-600 focus:border-red-600 block w-full p-2.5 dark:bg-yellow-800 dark:border-yellow-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="name@company.com" required />
                </div>
                <div>
                <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Password</label>
                <input type="password" onChange={changeval} value={newuser.password} name="password" id="password" placeholder="••••••••" className="bg-yellow-100 border border-yellow-300 text-gray-900 sm:text-sm rounded-lg focus:ring-red-600 focus:border-red-600 block w-full p-2.5 dark:bg-yellow-800 dark:border-yellow-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
                </div>
                <div>
                ...
                Already have an account? <a href="/login" className="font-medium text-red-600 hover:underline dark:text-red-500">Sign in</a>
                </p>
            </form>
            </div>
        </div>
