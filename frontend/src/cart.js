      ...
      <section className="container mx-auto py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {error ? (
            ...
            items.map((item) => (
              <div key={item.product} className="bg-orange-100 rounded-lg shadow-md p-4">
                <p className="text-lg font-semibold">Product ID: {item.product}</p>
        ...
        <div className="flex items-center justify-between mt-8">
          <div>
            <h2 className="text-xl font-semibold">Cart Total: Rs {ctotal}</h2>
          </div>
          <button className="bg-orange-500 hover:bg-orange-600 text-white px-6 py-3 rounded-md text-lg font-semibold transition duration-300 ease-in-out">
            Checkout
          </button>
        </div>
      </section>
